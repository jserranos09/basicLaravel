...
<div id="wrapper">
	<div id="page" class="container">
		...
		<div id="sidebar">
			<ul class="style1">
                <!-- articles is in web.php. connected tot he database. -->
                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="first">
                        <h3>
                            <!-- $article->id links to the correct destination/article. shows the title of the article -->
                            <a href="/articles/<?php echo e($article->id); ?>"><?php echo e($article->title); ?></a>
                        </h3>
                        <!-- Shows the excerpt of the artcile-->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/juan/juan.comet.software/resources/views/about.blade.php ENDPATH**/ ?>